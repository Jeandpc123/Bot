		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerG: '[❗] Este comando solo puede ser utilizado por un admins del grupo o el dueño del bot',
					ownerB: '[❗] Este comando solo lo usa terna',
					admin: '[❗] Este comando solo puede ser utilizado por administradores del grupo',
					Badmin: '[❗] Este comando solo se puede usar cuando el bot se convierte en administrador',
                                        pegatina: 'espera loco todo con calama  estoy haciendo tu sticker 👏\n\n*Recuerda los stickersgif son de 6 segundos*\n\n_*by botcito*_',
					attp: 'Espera bro tu texto  a sticker 👏\n\n*Esto puede demorar unos minutos*\n\n_*by botcito*_',
					imgs: 'Eh lco te gusta grandeee ehhhh ya ahi va tu  tu Sticker a Imagen 🔄*\n\n_*by botcito*_',
					mpcancion: 'Espera conero, tu sabes que siempre estoy ready  😎\n\n*Convirtiendo de MP4 a MP3 🔄*\n\n_*by botcito*_',
			...
			const ownerNumber = ["5742821697@s.whatsapp.net,51977878769@s.whatsapp.net"] // replace this with your number
